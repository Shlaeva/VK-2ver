...
//        переход на просмотр фото с анимацией
            guard segue.identifier == "showAnimatedPics" else { return }
//        переход на просмотр фото в коллекшн
...
//        переход на просмотр фото с анимацией
            guard let PicturesController = segue.destination as? PicturesAnimationViewController else { return }
//        переход на просмотр фото в коллекшн
